...
export const SERVER_FLAGS: FlagDef[] = [
  ...
  { id: "alias", flag: "--alias", label: "Model Alias", section: "Server", type: "string", default: "unknown", help: "Name shown to clients for this model in the OpenAI-compatible API." },
  ...
  { id: "metrics", flag: "--metrics", label: "Prometheus Metrics", section: "Server", type: "boolean", default: false, help: "Expose a /metrics endpoint with Prometheus-style statistics." },
  ...
  // ---- Context & Batching ----
  { id: "ctx-size", flag: "--ctx-size", label: "Context Size", section: "Context & Batching", type: "number", default: 131072, min: 64, max: 1048576, step: 1024, help: "Total context window in tokens shared across all parallel slots. Optimized default is 131072 for this RTX 3090 Ti profile.", alwaysEmit: true },
  { id: "batch-size", flag: "--batch-size", label: "Logical Batch Size", section: "Context & Batching", type: "number", default: 2048, min: 1, max: 65536, step: 1, help: "Maximum tokens processed in one prompt batch during evaluation." },
  { id: "ubatch-size", flag: "--ubatch-size", label: "Physical Batch Size", section: "Context & Batching", type: "number", default: 512, min: 1, max: 65536, step: 1, help: "Tokens processed in one physical compute step. Tune to fill GPU work." },
  ...
  { id: "predict", flag: "--n-predict", label: "Max Tokens To Predict", section: "Context & Batching", type: "number", default: -1, min: -1, max: 1048576, step: 1, help: "Maximum tokens the server generates per request. -1 means until end of turn." },

...
export const SERVER_FLAGS: FlagDef[] = [
  ...
  // ---- Context & Batching ----
  { id: "ctx-size", flag: "--ctx-size", label: "Context Size", section: "Context & Batching", type: "number", default: 125000, min: 64, max: 1048576, step: 1024, help: "Total context window in tokens shared across all parallel slots. Optimized default is 125000 for the loaded Ornith 35B profile on this RTX 3090 Ti.", alwaysEmit: true },
